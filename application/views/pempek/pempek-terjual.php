    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-12">
        	<!--<div class="card mb-5">
        		...
        		<div class="card-body">
        			<a href="<?= base_url('Pempek/printLaporan') ?>" class="btn btn-success" target="_blank"><i class="fas fa-print"></i> Print</a>
        	...
        	<div class="card mb-5">
        		...
        		<div class="card-body">
        			<?php if (!$print_by_bulan): ?>
        				<?php $print_by_bulan = ''; ?>
        			<?php endif ?>
        			<a href="<?= base_url('Pempek/printLaporan/'.$print_by_bulan) ?>" class="btn btn-success" target="_blank"><i class="fas fa-print"></i> Print</a>
        			...
        			<div class="btn-group dropright">
        				...
        				<div class="dropdown-menu">
        					<a class="dropdown-item" href="<?= base_url('Pempek/laporan/') ?>">All Data</a>
        					<?php foreach ($bulan as $item): ?>
        						<?php
        						$x = '01-'.$item['bulan'];
        						$dis_bulan = date('F Y', strtotime($x));
        						 ?>
        						<a class="dropdown-item" href="<?= base_url('Pempek/laporan/'.$item['bulan']) ?>"><?= $dis_bulan; ?></a>
        					<?php endforeach ?>
        				</div>
        			</div>
