	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-6">
				...
				<?php foreach ($pempek as $row): ?>
					<div class="card mb-3" style="max-width: 540px;">
						<div class="row no-gutters">
							<div class="col-md-4">
								<img src="<?= base_url('assets/img/pempek/').$row['gambar'] ?>" alt="<?= $row['gambar'] ?>" style="width: 180px;">
							</div>
							<div class="col-md-8">
								<div class="card-body">
									<h4 class="card-title" style="color: #a36362;"><?= $row['nama_pempek'] ?></h5>
									...
									<div class="btn btn-sm btn-success">Rp. <?= number_format($row['harga_jual'],2,',','.') ?></div>
...
<script type="text/javascript">
	...
	var keyword = document.getElementById('uang');
	...
	keyword.addEventListener('change', function () {
	    ...
	    xhr.open('GET', '<?= base_url('Transaksi/hitungKembalian/') ?>' + keyword.value + '/' + harga.value, true);
	    xhr.send();
